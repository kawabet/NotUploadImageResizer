...
function base64ToFile(src) {
  var filePropertyBag = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var resize = arguments.length > 2 ? arguments[2] : undefined;
  ...
  return new Promise(function (resolve, reject) {
    image.onload = function () {
      ...
      var base64 = canvas.toDataURL(filePropertyBag.type ? filePropertyBag.type : "image/webp"); // base64からBlobデータを作成
...
var originalView = document.querySelector('.original .preview');
var resizeView = document.querySelector('.resize .preview');
var originalSizeElement = document.querySelector('.original .size');
var resizeSizeElement = document.querySelector('.resize .size');
...
fileInput.addEventListener('change', function (event) {
  ...
  reader.onload = function (f) {
    ...
    (0, _index.base64ToFile)(f.target.result, file, lengthInput.value).then(function (res) {
      var url = window.URL.createObjectURL(res);
      var resizeImage = document.createElement('img');
      resizeImage.setAttribute('src', url);
      resizeView.append(resizeImage);
      originalSizeElement.innerHTML = (0, _numeral.default)(f.total).format('0.0 b');
      resizeSizeElement.innerHTML = (0, _numeral.default)(res.size).format('0.0 b');
    });
  };

  reader.readAsDataURL(file);
});
},{"../../index":"../../index.js","numeral":"../node_modules/numeral/numeral.js"}],"../../../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
