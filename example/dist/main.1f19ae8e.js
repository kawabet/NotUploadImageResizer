...
fileInput.addEventListener('change', function (event) {
  ...
  reader.onload = function (f) {
    ...
    (0, _index.base64ToFile)(f.target.result, lengthInput.value, file.name).then(function (res) {
      ...
      resizeSizeElement.innerHTML = "".concat((0, _numeral.default)(res.size).format('0.0 b'), " <small>-").concat(Math.floor((1 - res.size / f.total) * 100), "%</small>");
